...
export interface BookPage {
  ...
  environmentRefType?: 'environment' | 'clothing' | 'characters' | 'everything' | 'env_chars_clothes'; // Legacy, keep for backwards compatibility if needed
...
export type AppMode = 'restyle' | 'create' | 'upscale' | 'prompt-pack' | 'production-layout' | 'activity-builder' | 'retarget' | 'niche-research' | 'kdp-fixer' | 'cover-designer';
